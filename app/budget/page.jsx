                                    ...
                                    <div key={budget.id || budget.idBudget} className="budget-card">
                                        <div className="budget-card-header">
                                            ...
                                            <div className="budget-actions">
                                                ...
                                                <button 
                                                    ...
                                                    onClick={() => handleDeleteBudgetClick(budget.id || budget.idBudget)}
                                                    title="Delete"
                                                >
                                                    <FaTrash />
                                                </button>
                                        ...
                                        <div className="budget-amounts">
                                            <div className="amount-item">
                                                ...
                                                <span className={`amount-value ${isOverBudget ? 'over' : ''}`}>
                                                    Rp {progress.spent.toLocaleString('id-ID')}
                                                </span>
                                            </div>
                                            <div className="amount-item">
                                        ...
                                        {isOverBudget && (
                                            <div className="budget-warning">
                                                ⚠️ Over budget by Rp {progress.remaining.toLocaleString('id-ID')}
                                            </div>
                                        )}

                                        {!isOverBudget && progress.remaining > 0 && (
                                            <div className="budget-info">
                                                Rp {progress.remaining.toLocaleString('id-ID')} remaining
                                            </div>
                                        )}
                                    </div>
                                );
                            ...
                            <div className="summary-stats">
                                <div className="stat-item">
                                    ...
                                    <span className="stat-value">
                                        Rp {budgets.reduce((sum, b) => sum + parseFloat(b.limit || b.amount || 0), 0).toLocaleString('id-ID')}
                                    </span>
                                </div>
                                <div className="stat-item">
