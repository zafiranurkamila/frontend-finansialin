    ...
    const handleDownload = async () => {
        try {
            ...
            const categoryData = [
                ...
                [],
                ['No', 'Category', 'Transactions', 'Amount', 'Percentage'],
            ];
            ...
            const transactionData = [
                ['DETAIL TRANSAKSI'],
                [],
                ['No', 'Tanggal', 'Category', 'Keterangan', 'Debit', 'Kredit', 'Saldo'],
            ];
            ...
            transactionData.push([
                ...
                `Rp ${monthlyBalance.toLocaleString('id-ID')}`
            ]);
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div 
                                                ...
                                                style={{ color: color.text, textAlign: 'right' }}
                                            >
                                                Rp {data.amount.toLocaleString('id-ID')}
                                            </div>
                                            <div 
