...
import { FaTimes, FaCalendar, FaTag, FaFileAlt, FaWallet, FaDollarSign } from 'react-icons/fa';
                ...
                <div className="transaction-detail-content">
                    ...
                    <div className={`amount-section ${transaction.type}`}>
                        ...
                        <div className="amount-info">
                            <p className="amount-label">{transaction.type === 'income' ? 'Income' : 'Expense'}</p>
                        ...
                        <div className="detail-item">
                            ...
                            <div className="detail-content">
                                ...
                                <p className="detail-value">
                                    <span className={`type-badge-detail ${transaction.type}`}>
                    ...
                    <div className="additional-info">
                        <div className="info-row">
                            ...
                            <span className="info-value">{transaction.idTransaction || transaction.id}</span>
                        </div>
                        {transaction.userId && (
                            <div className="info-row">
