  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="main-content-area">
        ...
        <main className="main-content-wrapper">
          ...
          <div className="actions-bar">
            ...
            <button className="transaction-add-btn" onClick={() => setIsAddModalOpen(true)}>
              + Add Transaction
            </button>
          </div>
              ...
              <table className="transactions-table">
                ...
                <tbody>
                  {filteredTransactions.map((transaction) => {
                    const categoryName = transaction.category?.name || getCategoryById(transaction.idCategory)?.name || "Unknown";

                    return (
                      <tr key={transaction.id || transaction.idTransaction} onClick={() => handleTransactionClick(transaction)} style={{ cursor: "pointer" }} className="transaction-row-clickable">
                        ...
                        <td onClick={(e) => e.stopPropagation()}>
                          <div className="action-buttons">
                            <button className="action-btn edit" onClick={() => handleEditClick(transaction)} title="Edit">
                              <FaEdit />
                            </button>
                            <button className="action-btn delete" onClick={() => handleDeleteClick(transaction.idTransaction)} title="Delete">
                              <FaTrash />
                            </button>
                          </div>
                        </td>
      ...
      <TransactionDetailModal
        ...
        categoryName={selectedTransaction ? selectedTransaction.category?.name || getCategoryById(selectedTransaction.idCategory)?.name || "Uncategorized" : ""}
      />

      <ConfirmDialog isOpen={isAlertOpen} title="Delete Transaction" message="Are you sure you want to delete this transaction?" onConfirm={handleConfirmDelete} onCancel={handleCancelDelete} />
